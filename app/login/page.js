...
import Login from "@/templates/loginPage/login";
        ...
        <div className="relative z-10 p-20 w-full">
          <div className="relatice z-10">
            <div className="relative z-20 login-wrapper flex justify-center w-full text-white border-2 border-white rounded-2xl overflow-hidden">
              <div className="w-full text-center bg-white/10 backdrop-blur-sm p-15 max-sm:p-5">
                <h1 className="text-5xl font-bold mb-12 max-sm:text-3xl max-sm:mb-5">
                  Welcome
                </h1>
                <Login />
                <Link
                  href="/register"
                  className="block mt-5 hover:text-sky-500 transition duration-200 ease-in max-sm:mt-2 max-sm:text-sm"
                >
