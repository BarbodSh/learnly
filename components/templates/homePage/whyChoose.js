    ...
    <section className="dark:text-white">
      <div className="container">
        ...
        <div className="grid grid-cols-12 justify-between content-center gap-5">
          <div className="col-span-6 h-20 p-2 rounded-lg bg-white dark:bg-dark border-2 border-red-500 flex justify-center items-center gap-5">
            <FaChalkboardTeacher className="text-red-500 text-4xl" />
            <p className="text-xl font-bold">
              Learn from industry experts with years of hands-on experience.
            </p>
          </div>
          <div className="col-span-6 h-20 p-2 rounded-lg bg-white dark:bg-dark border-2 border-yellow-500 flex justify-center items-center gap-5">
            <FaLaptopCode className="text-yellow-500 text-4xl" />
            <p className="text-xl font-bold">
              Gain real-world skills by building practical projects.
            </p>
          </div>
          <div className="col-span-6 h-20 p-2 rounded-lg bg-white dark:bg-dark border-2 border-green-500 flex justify-center items-center gap-5">
            <FaInfinity className="text-green-500 text-4xl" />
            <p className="text-xl font-bold">
              Access all your courses anytime, forever — no deadlines.
            </p>
          </div>
          <div className="col-span-6 h-20 p-2 rounded-lg bg-white dark:bg-dark border-2 border-purple-500 flex justify-center items-center gap-5">
