...
import LinkForSidebar from "../Link/LinkForSidebar";
function PanelSidebar({ username }) {
        ...
        <div className="border-b-3 dark:border-white p-2 font-bold text-2xl border-dark flex justify-between items-center w-full">
          ...
          <div className="flex justify-start items-center gap-3">
            <Link
              href="/panel/profile"
              onClick={() => {
                setSidebar("/panel/profile");
              }}
            >
              <CiSettings className="text-3xl hover:text-sky-500 cursor-pointer" />
            </Link>
            <SlLogout
